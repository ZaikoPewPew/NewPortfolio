...
На странице кейса (`data-case-page`, desktop): без choreography — мгновенный переход; виджеты скрыты (`visibility` + absolute), cases на ширину `header__row`, cover `--layout-case-cover-height`, текст `--layout-case-reading-width` (751) по центру. Mobile без изменений.
